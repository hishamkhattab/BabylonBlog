...
const Login = () => {
  return (
    <div className="bg">
      ...
      <div class="position-absolute top-50 start-50 translate-middle w-75 rounded-2">
        <div className="d-flex justify-content-between align-items-center auth">
          <div className="auth-left w-25 py-4 px-3">
            <div>
              <h5 className="text-center text-uppercase mb-5 display-6">
                Babylon Blog
              </h5>
            ...
            <div>
              ...
              <button className="login-btn twitter">Signin with twitter</button>
              <button className="login-btn google">Signin with google</button>
            </div>
          </div>
          <div className="w-75 p-4 bg-light">
            <div>
              ...
              <p className="text-center">
                ...
                <span className="text-primary ms-1">Sign Up Free!</span>
              </p>
            </div>
